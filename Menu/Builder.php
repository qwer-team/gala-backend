...
class Builder extends ContainerAware
{
    ...
    public function navbar(FactoryInterface $factory, array $options)
    {
        ...
        $menu->addChild('Общие настройки', array('uri' => '#'));
        $space = $menu->addChild('Пространство', array('uri' => '#'));
            $space->addChild('Начальная загрузка', array('uri' => '#'));
            $space->addChild('Изминение координат', array('uri' => '#'));
            $space->addChild('Перегрузка', array('uri' => '#'));
            $space->addChild('Призы', array('uri' => '#'));
            $points = $space->addChild('Точки', array('uri' => '#'));
                $points->addChild('Черные', array('uri' => '#'));
                $points->addChild('Ловушка', array('uri' => '#'));
                $points->addChild('+%', array('uri' => '#'));
                $points->addChild('-%', array('uri' => '#'));
                $points->addChild('Кража флипера', array('uri' => '#'));
                $points->addChild('Сообщения', array('uri' => '#'));
                $points->addChild('Точка Ноль', array('uri' => '#'));
                $points->addChild('Ноль очков', array('uri' => '#'));
                $points->addChild('Супер прыжок', array('uri' => '#'));
        $menu->addChild('Флиперы', array('uri' => '#'));
        $menu->addChild('Счета', array('uri' => '#'));
        $menu->addChild('Страхование', array('uri' => '#'));
        $menu->addChild('Администрирование', array('route' => 'menu'));
        $menu->addChild('Отчеты', array('route' => 'galaxy_back_end_homepage'));
     ...
     * @return \Knp\Menu\ItemInterface The root item
     */
    public function navbar2(FactoryInterface $factory, array $options)
    {
        $menu = $factory->createItem('root');

        $menu->addChild('Общие настройки', array('uri' => '#'));
        $menu->addChild('Пространство', array('uri' => '#'));
        $menu->addChild('Флиперы', array('uri' => '#'));
        $menu->addChild('Счета', array('uri' => '#'));
        $menu->addChild('Страхование', array('uri' => '#'));
        $menu->addChild('Администрирование', array('route' => 'menu'));
     ...
     * @return \Knp\Menu\ItemInterface The root item
     */
    public function navbar3(FactoryInterface $factory, array $options)
    {
        $menu = $factory->createItem('root');

        $menu->addChild('Home', array('route' => 'galaxy_back_end_homepage'));
        $menu->addChild('menu', array('route' => 'menu'));
        $menu->addChild('Scaffolding', array('uri' => '#'));
        $menu->addChild('Base CSS', array('uri' => '#'));
        $menu->addChild('Components', array('uri' => '#'));
        $menu->addChild('Javascript', array('uri' => '#'));
        $menu->addChild('Forms', array('uri' => '#'));
