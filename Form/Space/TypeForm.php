...
class TypeForm extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
                ...
                ->add('onBet', 'checkbox', array('required' => false)
                )
                ...
                ->add('fl1', 'file', array('required' => false))
                ->add('fl2', 'file', array('required' => false))
                ->add('fl3', 'file', array('required' => false))
                ->add('fl4', 'file', array('required' => false))
                ->add('fileDelete1', 'checkbox', array('required' => false))
                ->add('fileDelete2', 'checkbox', array('required' => false))
                ->add('fileDelete3', 'checkbox', array('required' => false))
                ->add('fileDelete4', 'checkbox', array('required' => false))
                ->add('tag', 'hidden')
                ->add('id', 'hidden')
        ;
    }
